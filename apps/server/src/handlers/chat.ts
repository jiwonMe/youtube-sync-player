 ...
 * 채팅 메시지 처리
 */
export function handleChatMessage(socket: Socket, io: Server, message: string, userId: string, userName: string, userImage: string, roomId: string): void {
  ...
  // 방 상태 업데이트
  roomStore.updateRoom(roomId, { messages });
